...
//     let pool = Arc::new(
//         database::criar_pool().await.unwrap()
//     );
...
//         EnderecoEntregaRepository::new(pool);


//     // 2. Inicialização dos Services
//     let usuario_service = UsuarioService::new(
//         Arc::new(usuario_repo)
//     );

//     let loja_service = LojaService::new(
//         Arc::new(loja_repo), 
//         Arc::new(config_partes_repo), 
//         Arc::new(horario_repo), 
//         Arc::new(funcionario_repo), 
//         Arc::new(entregador_repo),
//         Arc::new(cliente_repo),
//         Arc::new(usuario_repo)
//     );

//     let catalogo_service = CatalogoService::new(
//         Arc::new(produto_repo),
//         Arc::new(categorias_de_produtos_repo),
//         Arc::new(adicional_repo)
//     );
...
//         Arc::new(config_partes_repo),
//         Arc::new(cupom_repo),
//         Arc::new(promocao_repo),
//         Arc::new(endereco_entrega_repo)
//     );

//     let marketing_service = MarketingService::new(
//         Arc::new(cupom_repo), 
//         Arc::new(promocao_repo), 
//         Arc::new(avaliacoes_de_loja_repo), 
//         Arc::new(avaliacoes_de_produto_repo)
//     );
