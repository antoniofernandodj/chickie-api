...
// use crate::{
//     handlers::{dto::AppError, AppState},
//     models::Usuario,
...
//     let mut pedido = chickie_core::models::Pedido::new(
...
//             let produto: Option<chickie_core::models::Produto> = state.produto_repo
...
//             partes.push(chickie_core::models::ParteDeItemPedido::new(&produto, parte_req.posicao));
//         }
