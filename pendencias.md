...
| # | Tarefa | Detalhe | Data |
|---|--------|---------|------|
| 30 | **Pedido sem usuário obrigatório** | `usuario_uuid` em `pedidos` agora é nullable (migration `0010`). `endereco_entrega` no body de `/api/pedidos/criar` é opcional. Endpoint sem auth obrigatória (usa `optional_auth_middleware`). Stack completa atualizada. | 2026-04-19 |
