...
| 22 | **Atualizar adicional** | Novo endpoint `PUT /api/catalogo/{loja_uuid}/adicionais/{adicional_uuid}` para editar nome, descrição e preço de adicional. Segue arquitetura Handler → Service → Repository. | 2026-04-09 |
